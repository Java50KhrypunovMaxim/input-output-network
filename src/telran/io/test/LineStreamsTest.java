...
class LineStreamsTest {
	...
	private static final int N_Lines = 5000000 ;
	...
	@Test
	@Order(5)
	@DisplayName("Perfocame for PrintWriter")
	void perfomaceWriterTest () throws Exception  {
	...
	@Test
	@Order(6)
	@DisplayName("Perfocame for PrintStream")
	void perfomaceStreamTest () throws Exception  {
